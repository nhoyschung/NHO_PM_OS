...
export const createTaskSchema = z
  .object({
    ...
    assigneeId: z.string().regex(UUID_REGEX, 'ID người được giao không hợp lệ').optional(),
    ...
    estimatedHours: z
      ...
      .optional(),
    parentTaskId: z.string().regex(UUID_REGEX, 'ID công việc cha không hợp lệ').optional(),
    tags: z
...
const updateTaskBase = z.object({
  ...
  status: TaskStatus,
  assigneeId: z.string().regex(UUID_REGEX).nullable(),
  ...
  parentTaskId: z.string().regex(UUID_REGEX).nullable(),
